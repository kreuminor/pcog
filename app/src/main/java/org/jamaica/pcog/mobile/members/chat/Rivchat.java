...
import org.jamaica.pcog.mobile.members.chat.data.StaticConfig;
import org.jamaica.pcog.mobile.members.chat.service.ServiceUtils;
import org.jamaica.pcog.mobile.members.chat.ui.FriendsFragment;
import org.jamaica.pcog.mobile.members.chat.ui.GroupFragment;
import org.jamaica.pcog.mobile.members.chat.ui.UserProfileFragment;

import java.util.ArrayList;
import java.util.List;

public class Rivchat extends AppCompatActivity {
    private static String TAG = "RivChat";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rivhcat);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Rivchat.this.finish();
                    // User is signed in
                    startActivity(new Intent(Rivchat.this, MainPage.class));
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ServiceUtils.stopServiceFriendChat(Rivchat.this.getApplicationContext(), false);
                if (adapter.getItem(position) instanceof FriendsFragment) {
                    floatButton.setVisibility(View.VISIBLE);
                    floatButton.setOnClickListener(((FriendsFragment) adapter.getItem(position)).onClickFloatButton.getInstance(Rivchat.this));
                    floatButton.setImageResource(R.drawable.ic_float_button);
                } else if (adapter.getItem(position) instanceof GroupFragment) {
                    floatButton.setVisibility(View.VISIBLE);
                    floatButton.setOnClickListener(((GroupFragment) adapter.getItem(position)).onClickFloatButton.getInstance(Rivchat.this));
