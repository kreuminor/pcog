...
public class Youtube extends AppCompatActivity implements AdvancedWebView.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("https://www.youtube.com/channel/UCZ0-CkyzQTqxt753wD8M9Ig");
    ...
    public void onPageError(int errorCode, String description, String failingUrl) {
        if (errorCode == -2) {
            ...
            builder.setMessage(Html.fromHtml("<font color='#120049'>The Youtube Page will not open, your data services are not working. Please check your data services.</font>"));
